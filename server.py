...
from resources import PinsResource, SequencesResource, PinResource, SequenceResource, PinSchema
...
PARSER = argparse.ArgumentParser(description=
                                 'Timeswitch for the GPIOs of an Raspberry Pi with a webinterface.')
PARSER.add_argument('--file', dest='schedule_file', metavar='file', type=str,
                    help='A JSON-file containing the schedule.', required=True)

PARSER.add_argument('--debug', dest='debug', default=False, const=True, nargs="?",
...
API.add_resource(PinsResource, '/api/pins',
                 resource_class_kwargs={'switch_manager':SWITCH_MANAGER})
