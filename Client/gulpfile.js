...
var gulp = require('gulp'), rjs = require('gulp-requirejs-bundler'), concat = require('gulp-concat'), clean = require('gulp-clean'), filter = require('gulp-filter'),
    replace = require('gulp-replace'), uglify = require('gulp-uglify'), htmlreplace = require('gulp-html-replace'), rename = require('gulp-rename'),
...
gulp.task('css', function () {
    ...
    return allCss.pipe(rename('css.css')).pipe(gulp.dest('./dist/'));
});
...
gulp.task('default', ['html', 'js', 'css', 'img'], function(callback) {
    callback();
